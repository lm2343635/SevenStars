...
<% 
	ArrayList<User> salesmans=UserDao.getByPrivilege(UserDao.FRANCHISEE);
%>
...
<body>
	<p class="title">
		<span class="glyphicon glyphicon-leaf" style="margin-right: 5px;"></span>  <span style="color: #bbb;">\</span> 加盟店管理
		<span class="dtT">
	...
	<div class="pop-box" id="new-user">
		...
		<div class="pop-content">
			<form id="add-new-user" >
				...
				<input type="hidden" id="privilege" value="2">
	...
	<div class="pop-box" id="modify-user">
		<div class="pop-title"><p>修改加盟商</p></div>
		<div class="pop-content">
			<table>
				<tr>
					<td><span>加盟商编号：</span></td>
				...
				<tr>
					<td><span>原加盟商姓名：</span></td>
		            <td><span id="old-uname"></span></td>
				</tr>
				<tr>
					<td><span>修改加盟商姓名：</span></td>
