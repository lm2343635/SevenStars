...
<%
	ArrayList<User> salesmans=UserDao.getByPrivilege(UserDao.MULTIPLE); 
%>
...
<body>
	<p class="title">
		<span class="glyphicon glyphicon-leaf" style="margin-right: 5px;"></span>  <span style="color: #bbb;">\</span> 连锁店管理
		<span class="dtT">
	...
	<div class="pop-box" id="modify-user">
		<div class="pop-title"><p>修改连锁商</p></div>
		<div class="pop-content">
			<table>
				<tr>
					<td><span>连锁商编号：</span></td>
				...
				<tr>
					<td><span>原连锁商姓名：</span></td>
		            <td><span id="old-uname"></span></td>
				</tr>
				<tr>
					<td><span>修改连锁商姓名：</span></td>
